<?php
	...
	class Wechat_base_api{
      ...
      // print_r($res2['nickname']);
         $scene_id=    $obj->EventKey;
         $event=       $obj->Event;
         $CreateTime=  $obj->CreateTime;  
		 $scene_id = preg_replace('/[qrscene_]+/i','',$scene_id); 
		 include "config.php";
         $query=" insert into aguanzhu  (sceneid,username,time) values ('{$scene_id}','{$FromUserName}','{$CreateTime}')";
         ...
         $dataArray = array(
		 							array(
		 								...
		 								"Url"=>"http://a994724435.017.wwwcnc.com/tanwei/user/index.php?xh=".$scene_id
		 								),
		  							array(
		 								"Title"=>"晋赶1",
		 								"Description"=>"this is a test",
		...
		$dataArray = array(
		 							array(
		 								...
		 								"Description"=>"this is a test",
		 								"PicUrl"=>"http://yunkt.qiniudn.com/wxdzp_bg.jpg",
		 								"Url"=>"http://a994724435.017.wwwcnc.com/tanwei/user/index.php?xh=".$username
		 								),
		  							array(
		 								"Title"=>"测试2",
		 								"Description"=>"this is a test",
